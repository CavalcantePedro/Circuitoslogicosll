                		...
                		for(f=0; f<=1;f++){
                			for(g=0; g<=1;g++){
                				for(h=0; h<=1; h++){
                                    ...
                                    fprintf(fp, "%d%d%d%d%d%d%d%d_%d_%d%d%d%d%d%d%d%d\n", a, b, c, d, e, f, g, h, clock, anterior_a, anterior_b, anterior_c, anterior_d, anterior_e, anterior_f, anterior_g, anterior_h);  // escreve a combina�ao pela primeira vez
					                clock = 1; // gera o clock para os Flip-Flops (sens�vel � borda de subida)
                                    fprintf(fp, "%d%d%d%d%d%d%d%d_%d_%d%d%d%d%d%d%d%d\n", a, b, c, d, e, f, g, h, clock, a, b, c, d, e, f, g, h); // escreve a combina��o pela segunda vez
